...
<body class="bg-[#f4f6f9] min-h-screen flex flex-col justify-between font-sans">
        ...
        <div class="container mx-auto flex justify-between items-center px-6 py-3">
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden md:flex space-x-1 text-xs font-medium pt-1">
                    <span class="px-3 py-1 bg-[#003561] rounded text-white font-semibold">Inicio</span>
                    <span class="px-3 py-1 text-gray-300 hover:text-white cursor-pointer transition">Seguimiento & Registro</span>
                </div>
            </div>
    ...
    <main class="container mx-auto my-8 max-w-xl px-4 flex-grow">
        <div class="mb-4">
            <h2 class="text-2xl font-light text-gray-700">Inicio <span class="text-sm text-gray-400 font-normal">/ cuadro de eventos e información</span></h2>
        </div>
        ...
        <div class="bg-white rounded border-t-4 border-red-500 shadow p-6">
            ...
            <form id="formIncidente" action="{{ route('incidentes.store') }}" method="POST" class="space-y-4 text-sm text-gray-600">
                @csrf
                <div>
                    <label class="block font-medium mb-1">Título del Incidente</label>
                    <input type="text" id="titulo" name="titulo" class="w-full border border-gray-300 p-2 rounded focus:ring-1 focus:ring-blue-500 outline-none" placeholder="Ej. Corte de energía Bloque B">
                </div>

                <div>
                    <label class="block font-medium mb-1">Tipo de Incidente</label>
                    <select id="tipo_incidente" name="tipo_incidente" class="w-full border border-gray-300 p-2 rounded bg-white focus:ring-1 focus:ring-blue-500 outline-none">
                ...
                <div>
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4" class="w-full border border-gray-300 p-2 rounded focus:ring-1 focus:ring-blue-500 outline-none" placeholder="Describa la emergencia aquí..."></textarea>
                </div>

                <button type="submit" class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 rounded transition duration-200 shadow-sm uppercase tracking-wider text-xs">
                    Reportar Incidente
                </button>
            </form>
        </div>
